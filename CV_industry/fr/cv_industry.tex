...
%\newline
%\newline
Le projet de recherche est basé sur la métrologie de temps et fréquence, plus précisement, le développement de la future génération d'horloge optique qui vont donner le temps légal en France.
...
%\newline
%\newline
La recherche développé pendant mon doctorat a eu lieu au CERN dans le cadre de la collaboration ALPHA. Parmi les nombreux résultats, le plus important est la détermination ultra précise de la fréquence absolue de la transition atomique en antihydrogène.
...
\cventry{2005--2007}{diplôme de technicien en életronique}{Centro Federal de Educação Tecnológica Celso Suckow da Fonseca}{CEFET/RJ}{\textit{Brésil}}{}
...
\begin{minipage}{0.5\textwidth}
    ...
    \cvitem{L'analyse des données}{Python, Cpp, MatLab.}
...
\begin{minipage}{0.5\textwidth}
    ...
    \cvitemwithcomment{Espagnol}{Intermediare -- B1/B2}{}
    \cvitemwithcomment{Français}{Intermediare -- B1/B2}{}
    \section{Centre d'intérêt}
    La musique (basse et guitare acoustique), langues, cuisine, football, cyclism.
% \cventry{Music}{Passionate about music. I dedicate to acoustic and bass guitar since I was 14 years old. I have basic skills on drums.}{}{}{}{}
% \cventry{Languages}{One of the reasons why I came abroad. Learning languages has been a constant dedication ever since together with full immersion in the cultures of the countries I have lived and visited.}{}{}{}{}
\end{minipage}
