...
\familyname{Ximenez R. Alves} % Your last name
...
\extrainfo{Birth date: 12/10/1988, Nationality: Brazilian}
...
\cventry{June/2018--present}{Post--doc at SYRTE: Strontium optical lattice clocks}{}{France}{}{
%\newline
%\newline
...
\cventry{2015--2018}{PhD: \textit{Laser spectrocopy of antihydrogen and fundamental symmetries}}{}{CERN/Aarhus University--Denmark}{}{
%\newline
%\newline
...
\cventry{2013--2015}{Masters at UFRJ}{\textsc{Rio de Janeiro}}{Brazil}{}{
%\newline
%\newline
    Masters in laser spectroscopy of Lithium atoms and molecules (Li$_{2}$, CaH) in cryogenic environment. 
%\newline
%\newline
}
...
\cventry{2013}{Summer Student}{\textsc{CERN}}{Switzerland}{}{
    Internship at CERN working at the ALPHA collaboration at the Antiproton decelerator: development of electronics integrating the FPGA pressure control system of the cryostat. 
}
%\newline{}\newline{}

\cventry{2008}{Elevadores Ideal (Elevator company)}{Rio de Janeiro}{Brazil}{}{
    Company dedicated to elevators in residencial and commercial buildings. I was responsible for the Modernization department, in charge of replacing old electric relay-based elevator boards by modern electronic technology based on microcontrollers and frequency inverters.
}
...
\section{Other degrees and relevant training}

\cventry{2017}{Frequency combs training}{Menlo Systems}{Germany}{}{}
\cventry{2008--2012}{Bachelor in Physics}{Universidade Federal do Rio de Janeiro}{UFRJ}{\textit{Brazil}}{}
\cventry{2005--2007}{Technician degree in electronics}{Centro Federal de Educação Tecnológica Celso Suckow da Fonseca}{CEFET/RJ}{\textit{Brazil}}{}
...
\begin{minipage}{0.5\textwidth}
    ...
    \cvitem{Data analysis}{Python, Cpp, Mathematica.}
    \cvitem{Mechanical designs}{Solid Works, Inventor.}
    \cvitem{Hardware control}{\textsc{LabView}, Arduino.}
    \cvitem{Electronics design}{PCBExpress, Altium.}
\end{minipage}
\begin{minipage}{0.5\textwidth}
    \section{Languages}
    ...
    \cvitemwithcomment{French}{Intermediare -- B1/B2}{}
    \section{A few hobbies}
    Music (bass and acoustic guitar), languages, cooking, gardening, football, cycling.
% \cventry{Music}{Passionate about music. I dedicate to acoustic and bass guitar since I was 14 years old. I have basic skills on drums.}{}{}{}{}
% \cventry{Languages}{One of the reasons why I came abroad. Learning languages has been a constant dedication ever since together with full immersion in the cultures of the countries I have lived and visited.}{}{}{}{}
\end{minipage}
